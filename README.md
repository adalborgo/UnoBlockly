...
- for installation: ([UnoBlockly_x64-Install-beta0.4.9.exe](https://www.dibis.it/UnoBlockly/UnoBlockly_x64-Install-beta0.4.9.exe))
- portable version: ([UnoBlockly_x64-beta0.4.9.zip](https://www.dibis.it/UnoBlockly/UnoBlockly_x64-beta0.4.9.zip))
